      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-10 mt-10">
        <div class="my-card rounded-2xl h-[300px] bg-base-100 my-shadow-icon hover:bg-primary duration-500 ">
          <div class="p-10 space-y-5 card-info duration-700">
            ...
            <h2 class="text-3xl font-[500] ">Javascript Development</h2>
        ...
        <div class="my-card rounded-2xl h-[300px] bg-base-100 my-shadow-icon hover:bg-primary duration-500 ">
          <div class="p-10 space-y-5 card-info duration-700">
            ...
            <h2 class="text-3xl font-[500] ">React application Development</h2>
            <p className="text-md text-gray-500 ">
              I throw myself down among the tall grass by the stream as I lie
              close to the earth
            </p>
        ...
        <div class="my-card rounded-2xl h-[300px] bg-base-100 my-shadow-icon hover:bg-primary duration-500 ">
          <div class="p-10 space-y-5 card-info duration-700">
            ...
            <h2 class="text-3xl font-[500] ">Front-end Development</h2>
            <p className="text-md text-gray-500 ">
              I throw myself down among the tall grass by the stream as I lie
              close to the earth
            </p>
        ...
        <div class="my-card rounded-2xl h-[300px] bg-base-100 my-shadow-icon hover:bg-primary duration-500 ">
          <div class="p-10 space-y-5 card-info duration-700">
            ...
            <h2 class="text-3xl font-[500] ">Web Design</h2>
            <p className="text-md text-gray-500 ">
              I throw myself down among the tall grass by the stream as I lie
              close to the earth
            </p>
        ...
        <div class="my-card rounded-2xl h-[300px] bg-base-100 my-shadow-icon hover:bg-primary duration-500 ">
          <div class="p-10 space-y-5 card-info duration-700">
            ...
            <h2 class="text-3xl font-[500] ">Web Development</h2>
            <p className="text-md text-gray-500 ">
              I throw myself down among the tall grass by the stream as I lie
              close to the earth
            </p>
        ...
        <div class="my-card rounded-2xl h-[300px] bg-base-100 my-shadow-icon hover:bg-primary duration-500 ">
          <div class="p-10 space-y-5 card-info duration-700">
            ...
            <h2 class="text-3xl font-[500] ">App Development</h2>
            <p className="text-md text-gray-500 ">
              I throw myself down among the tall grass by the stream as I lie
              close to the earth
            </p>
